...
<a href="https://apt.izzysoft.de/fdroid/index/apk/su.comp.bk">
  <img alt="Доступно в IzzyOnDroid" src="https://gitlab.com/IzzyOnDroid/repo/-/raw/master/assets/IzzyOnDroid.png" height="80">
</a>
 ...
 * Звуковой 8-битный ЦАП Covox (моно/стерео)
 * Музыкальный сопроцессор AY-3-8910 с поддержкой режима 2xAY по стандарту TurboSound
 * Блок музыкального синтезатора "Менестрель"
